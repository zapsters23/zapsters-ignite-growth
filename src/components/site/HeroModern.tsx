  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 -z-20">
        ...
        <div className="absolute top-1/2 right-1/4 w-[400px] h-[400px] bg-gradient-to-r from-violet-900/15 to-purple-900/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "2s" }}></div>
        <div className="absolute bottom-1/4 left-1/3 w-[350px] h-[350px] bg-gradient-to-r from-indigo-900/15 to-violet-900/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "4s" }}></div>
        <div className="absolute bottom-1/3 right-1/3 w-[300px] h-[300px] bg-gradient-to-r from-purple-900/10 to-pink-900/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }}></div>
      </div>
